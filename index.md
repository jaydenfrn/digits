...
First, [download a copy of Digits](https://github.com/jaydenfrn/digits). Note that Digits is a private repo and so you will need to request permission from the author to gain access to the repo.
